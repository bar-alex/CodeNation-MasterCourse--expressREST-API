...
// will return the user data (minust the pass) for the user who's token was passed in the header
userRouter.get("/user/token", tokenCheck, errMiddleware, getUsers)
